...
const STATIC_ROUTES: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
  ...
  { path: "/move-in-paris-vs-paris-attitude", priority: 0.85, changeFrequency: "monthly" },
  { path: "/move-in-paris-vs-lodgis", priority: 0.85, changeFrequency: "monthly" },
  { path: "/move-in-paris-vs-my-flat-in-paris", priority: 0.85, changeFrequency: "monthly" },
