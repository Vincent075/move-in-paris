...
type Article = {
  ...
  image: string;
  tags: string[];
  // Articles generated by the blog AI start as "draft" and must not appear
  // publicly until reviewed and published from the admin. Legacy articles
  // have no status field — those are treated as published.
