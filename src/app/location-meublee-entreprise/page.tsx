      ...
      <main>
        ...
        <SEOLanding
          ...
          relatedLinks={[
            ...
            { href: "/move-in-paris-vs-paris-attitude", label: "Move in Paris vs Paris Attitude" },
            { href: "/move-in-paris-vs-lodgis", label: "Move in Paris vs Lodgis" },
            { href: "/move-in-paris-vs-my-flat-in-paris", label: "Move in Paris vs My Flat in Paris" },
