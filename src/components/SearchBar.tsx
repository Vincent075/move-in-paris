      ...
      >
        <div className="bg-white shadow-2xl shadow-noir-deep/15 p-2.5 flex flex-col md:flex-row items-stretch border border-gris-clair/30">
          ...
          <div className="flex-1 px-5 py-3.5 border-b md:border-b-0 md:border-r border-gris-clair/20">
            <div className="text-[10px] text-gold uppercase tracking-[0.15em] font-semibold mb-1.5">Localisation</div>
            <select
              value={loc}
          ...
          {/* Surface min */}
          <div className="flex-1 px-5 py-3.5 border-b md:border-b-0 md:border-r border-gris-clair/20">
            <div className="text-[10px] text-gold uppercase tracking-[0.15em] font-semibold mb-1.5">Surface min</div>
            <input
              type="text"
              value={surfaceMin}
